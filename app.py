...
pokemon_df = pd.read_sql_query('SELECT * FROM Pokemon_Info',conn)
type_df = pd.read_sql_query('SELECT * FROM Pokemon_Types',conn)
raw_eff = pd.read_sql_query('SELECT * FROM Type_Effectiveness',conn)
